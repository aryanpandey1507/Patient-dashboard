          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="warning" stats icon>
                ...
                <p className={classes.cardCategory}>Fats</p>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="success" stats icon>
                ...
                <p className={classes.cardCategory}>Proteins</p>
                <h3 className={classes.cardTitle}>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="danger" stats icon>
                ...
                <p className={classes.cardCategory}>Carbohydrates</p>
                <h3 className={classes.cardTitle}>
          ...
          <GridItem xs={12} sm={6} md={3}>
            <Card>
              <CardHeader color="info" stats icon>
                ...
                <p className={classes.cardCategory}>Vitamins and minerals</p>
                <h3 className={classes.cardTitle}>
        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={6}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Last Week Physical Activity</h4>
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Calorie Burnt</h4>
                <p className={classes.cardCategory}>
                  <span className={classes.successText}>
                    <ArrowUpward className={classes.upArrowCardCategory} />
          ...
          <GridItem xs={12} sm={12} md={6}>
            <Card chart>
              ...
              <CardBody>
                <h4 className={classes.cardTitle}>Calorie Intake</h4>
                <p className={classes.cardCategory}>
                  <span className={classes.successText}>
                    <ArrowUpward className={classes.upArrowCardCategory} />
                    {this.getDiff(moodData.series)}%
